...
system_v_demosaic_0_0_reg_unsigned_short_s grp_reg_unsigned_short_s_fu_310(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
system_v_demosaic_0_0_reg_unsigned_short_s grp_reg_unsigned_short_s_fu_316(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (posedge ap_clk) begin
    if ((~((1'b0 == HwReg_bayer_phase_out_full_n) | (1'b1 == ap_block_state2_on_subcall_done)) & (1'b1 == ap_CS_fsm_state2))) begin
        tmp_i_i_122_reg_382 <= grp_reg_unsigned_short_s_fu_316_ap_return;
...
assign exitcond3_i_i_fu_342_p2 = ((j_i_i_reg_206 == tmp_i_i_122_reg_382) ? 1'b1 : 1'b0);
