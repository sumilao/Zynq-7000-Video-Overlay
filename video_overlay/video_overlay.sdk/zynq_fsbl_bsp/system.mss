...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = inner_ctrl
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = image_processing_inner_ctrl_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = resize_ip
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = image_processing_resize_ip_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = sobel_ip
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = image_processing_sobel_ip_0
END
