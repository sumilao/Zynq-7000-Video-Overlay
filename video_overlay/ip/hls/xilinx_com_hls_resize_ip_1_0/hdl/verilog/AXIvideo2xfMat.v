...
reg   [0:0] tmp_45_i_reg_446;
reg   [0:0] brmerge_i_reg_455;
wire    ap_CS_fsm_pp2_stage0;
reg    ap_enable_reg_pp2_iter1;
wire    ap_block_pp2_stage0;
reg   [0:0] eol_2_i_reg_304;
reg    img_rows_blk_n;
reg    img_cols_blk_n;
reg    img_data_V_blk_n;
reg    img_rows_out_blk_n;
reg    img_cols_out_blk_n;
reg   [0:0] eol_i_reg_234;
reg   [10:0] j_i_reg_246;
reg   [0:0] eol_reg_257;
reg   [31:0] axi_data_V_1_i_reg_268;
reg   [0:0] axi_last_V_3_i_reg_315;
reg   [31:0] axi_data_V_3_i_reg_327;
reg   [31:0] rows_reg_407;
reg    ap_block_state1;
reg   [31:0] cols_reg_412;
reg   [31:0] tmp_data_V_reg_417;
reg   [0:0] tmp_last_V_reg_425;
wire   [0:0] tmp_43_i_fu_362_p2;
wire    ap_CS_fsm_state4;
wire   [9:0] i_fu_367_p2;
reg   [9:0] i_reg_441;
wire   [0:0] tmp_45_i_fu_377_p2;
wire    ap_block_state5_pp1_stage0_iter0;
reg    ap_predicate_op71_read_state6;
reg    ap_block_state6_pp1_stage0_iter1;
reg    ap_block_pp1_stage0_11001;
wire   [10:0] j_fu_382_p2;
reg    ap_enable_reg_pp1_iter0;
wire   [0:0] brmerge_i_fu_391_p2;
...
reg   [0:0] ap_phi_mux_eol_2_i_phi_fu_307_p4;
reg   [0:0] axi_last_V1_i_reg_203;
wire    ap_CS_fsm_state10;
wire    ap_CS_fsm_state3;
reg   [31:0] axi_data_V1_i_reg_213;
reg   [9:0] i_i_reg_223;
reg   [0:0] ap_phi_mux_eol_i_phi_fu_238_p4;
reg   [0:0] ap_phi_mux_axi_last_V_2_i_phi_fu_284_p4;
reg   [31:0] ap_phi_mux_p_Val2_s_phi_fu_296_p4;
wire   [0:0] ap_phi_reg_pp1_iter1_axi_last_V_2_i_reg_279;
wire   [31:0] ap_phi_reg_pp1_iter1_p_Val2_s_reg_292;
reg    ap_block_pp1_stage0_01001;
reg   [0:0] sof_1_i_fu_146;
wire   [31:0] i_cast_i_fu_358_p1;
wire   [31:0] j_cast_i_fu_373_p1;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((tmp_43_i_fu_362_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_pp1_stage0_subdone) & (tmp_45_i_fu_377_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
            ap_enable_reg_pp1_iter0 <= 1'b0;
        end else if (((tmp_43_i_fu_362_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_pp2_stage0_subdone) & (ap_phi_mux_eol_2_i_phi_fu_307_p4 == 1'd1) & (1'b1 == ap_CS_fsm_pp2_stage0))) begin
            ap_enable_reg_pp2_iter0 <= 1'b0;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp1_stage0_11001) & (tmp_45_i_reg_446 == 1'd1) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (posedge ap_clk) begin
    ...
    end else if (((1'b0 == ap_block_pp2_stage0_11001) & (eol_2_i_reg_304 == 1'd0) & (ap_enable_reg_pp2_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp2_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp1_stage0_11001) & (tmp_45_i_fu_377_p2 == 1'd1) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp1_stage0_11001) & (tmp_45_i_fu_377_p2 == 1'd1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (*) begin
    if ((((1'b0 == ap_block_pp2_stage0_11001) & (eol_2_i_reg_304 == 1'd0) & (ap_enable_reg_pp2_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp2_stage0)) | ((1'b0 == ap_block_pp1_stage0_11001) & (ap_predicate_op71_read_state6 == 1'b1) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0)) | ((1'b1 == AXI_video_strm_V_data_V_0_vld_out) & (1'b1 == ap_CS_fsm_state2)))) begin
...
always @ (*) begin
    if (((tmp_43_i_fu_362_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((eol_2_i_reg_304 == 1'd0) & (1'b0 == ap_block_pp2_stage0) & (ap_enable_reg_pp2_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp2_stage0))) begin
...
always @ (*) begin
    if (((tmp_45_i_reg_446 == 1'd1) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) | ((eol_2_i_reg_304 == 1'd0) & (1'b0 == ap_block_pp2_stage0) & (ap_enable_reg_pp2_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp2_stage0)) | ((tmp_45_i_reg_446 == 1'd1) & (brmerge_i_reg_455 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0)))) begin
...
always @ (*) begin
    ap_block_pp1_stage0_01001 = ((ap_enable_reg_pp1_iter1 == 1'b1) & (((1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_predicate_op71_read_state6 == 1'b1)) | ((tmp_45_i_reg_446 == 1'd1) & (img_data_V_full_n == 1'b0))));
end

always @ (*) begin
    ap_block_pp1_stage0_11001 = ((ap_enable_reg_pp1_iter1 == 1'b1) & (((1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_predicate_op71_read_state6 == 1'b1)) | ((tmp_45_i_reg_446 == 1'd1) & (img_data_V_full_n == 1'b0))));
end

always @ (*) begin
    ap_block_pp1_stage0_subdone = ((ap_enable_reg_pp1_iter1 == 1'b1) & (((1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_predicate_op71_read_state6 == 1'b1)) | ((tmp_45_i_reg_446 == 1'd1) & (img_data_V_full_n == 1'b0))));
end

assign ap_block_pp2_stage0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_pp2_stage0_11001 = ((eol_2_i_reg_304 == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_enable_reg_pp2_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp2_stage0_subdone = ((eol_2_i_reg_304 == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_enable_reg_pp2_iter1 == 1'b1));
end
...
always @ (*) begin
    ap_block_state6_pp1_stage0_iter1 = (((1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_predicate_op71_read_state6 == 1'b1)) | ((tmp_45_i_reg_446 == 1'd1) & (img_data_V_full_n == 1'b0)));
end

assign ap_block_state8_pp2_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state9_pp2_stage0_iter1 = ((eol_2_i_reg_304 == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_0_vld_out));
end

always @ (*) begin
    ap_condition_507 = ((tmp_45_i_reg_446 == 1'd1) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0));
end
...
assign ap_phi_reg_pp1_iter1_axi_last_V_2_i_reg_279 = 'bx;

assign ap_phi_reg_pp1_iter1_p_Val2_s_reg_292 = 'bx;

always @ (*) begin
    ap_predicate_op71_read_state6 = ((tmp_45_i_reg_446 == 1'd1) & (brmerge_i_reg_455 == 1'd0));
end

assign brmerge_i_fu_391_p2 = (sof_1_i_fu_146 | ap_phi_mux_eol_i_phi_fu_238_p4);

assign i_cast_i_fu_358_p1 = i_i_reg_223;

assign i_fu_367_p2 = (i_i_reg_223 + 10'd1);

assign img_cols_out_din = img_cols_dout;

assign img_data_V_din = ap_phi_mux_p_Val2_s_phi_fu_296_p4[23:0];

assign img_rows_out_din = img_rows_dout;

assign j_cast_i_fu_373_p1 = j_i_reg_246;

assign j_fu_382_p2 = (j_i_reg_246 + 11'd1);

assign p_src_TREADY = AXI_video_strm_V_dest_V_0_state[1'd1];

assign tmp_43_i_fu_362_p2 = (($signed(i_cast_i_fu_358_p1) < $signed(rows_reg_407)) ? 1'b1 : 1'b0);

assign tmp_45_i_fu_377_p2 = (($signed(j_cast_i_fu_373_p1) < $signed(cols_reg_412)) ? 1'b1 : 1'b0);
