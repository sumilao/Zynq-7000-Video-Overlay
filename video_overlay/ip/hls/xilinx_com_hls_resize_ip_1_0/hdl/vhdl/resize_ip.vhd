...
architecture behav of resize_ip is 
    attribute CORE_GENERATION_INFO : STRING;
    attribute CORE_GENERATION_INFO of behav : architecture is
    "resize_ip,hls_ip_2018_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=12.395000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=46,HLS_SYN_DSP=108,HLS_SYN_FF=9622,HLS_SYN_LUT=15413,HLS_VERSION=2018_2}";
    ...
    signal src_height : STD_LOGIC_VECTOR (31 downto 0);
    signal src_width : STD_LOGIC_VECTOR (31 downto 0);
    signal dst_height : STD_LOGIC_VECTOR (31 downto 0);
    signal dst_width : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal resize_accel_U0_ap_start : STD_LOGIC;
    signal resize_accel_U0_ap_done : STD_LOGIC;
    signal resize_accel_U0_ap_continue : STD_LOGIC;
    signal resize_accel_U0_ap_idle : STD_LOGIC;
    signal resize_accel_U0_ap_ready : STD_LOGIC;
    signal resize_accel_U0_start_out : STD_LOGIC;
    signal resize_accel_U0_start_write : STD_LOGIC;
    signal resize_accel_U0_p_src_rows_read : STD_LOGIC;
    signal resize_accel_U0_p_src_cols_read : STD_LOGIC;
    signal resize_accel_U0_p_src_data_V_read : STD_LOGIC;
    signal resize_accel_U0_p_dst_rows_read : STD_LOGIC;
    signal resize_accel_U0_p_dst_cols_read : STD_LOGIC;
    signal resize_accel_U0_p_dst_data_V_din : STD_LOGIC_VECTOR (23 downto 0);
    signal resize_accel_U0_p_dst_data_V_write : STD_LOGIC;
    signal resize_accel_U0_p_dst_rows_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal resize_accel_U0_p_dst_rows_out_write : STD_LOGIC;
    signal resize_accel_U0_p_dst_cols_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal resize_accel_U0_p_dst_cols_out_write : STD_LOGIC;
    ...
    signal xfMat2AXIvideo_U0_p_dst_TDATA : STD_LOGIC_VECTOR (31 downto 0);
    signal xfMat2AXIvideo_U0_p_dst_TVALID : STD_LOGIC;
    signal xfMat2AXIvideo_U0_p_dst_TKEEP : STD_LOGIC_VECTOR (3 downto 0);
    signal xfMat2AXIvideo_U0_p_dst_TSTRB : STD_LOGIC_VECTOR (3 downto 0);
    ...
    signal imgInput1_data_V_cha_dout : STD_LOGIC_VECTOR (23 downto 0);
    signal imgInput1_data_V_cha_empty_n : STD_LOGIC;
    signal imgInput1_rows_c9_full_n : STD_LOGIC;
    signal imgInput1_rows_c9_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal imgInput1_rows_c9_empty_n : STD_LOGIC;
    signal imgInput1_cols_c10_full_n : STD_LOGIC;
    signal imgInput1_cols_c10_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal imgInput1_cols_c10_empty_n : STD_LOGIC;
    signal imgOutput1_data_V_ch_full_n : STD_LOGIC;
    signal imgOutput1_data_V_ch_dout : STD_LOGIC_VECTOR (23 downto 0);
    signal imgOutput1_data_V_ch_empty_n : STD_LOGIC;
    signal imgOutput1_rows_c11_full_n : STD_LOGIC;
    signal imgOutput1_rows_c11_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal imgOutput1_rows_c11_empty_n : STD_LOGIC;
    signal imgOutput1_cols_c12_full_n : STD_LOGIC;
    signal imgOutput1_cols_c12_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal imgOutput1_cols_c12_empty_n : STD_LOGIC;
    ...
    signal start_for_resize_accel_U0_din : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_resize_accel_U0_full_n : STD_LOGIC;
    signal start_for_resize_accel_U0_dout : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_resize_accel_U0_empty_n : STD_LOGIC;
    ...
    port (
        ...
        src_height : IN STD_LOGIC_VECTOR (31 downto 0);
        src_width : IN STD_LOGIC_VECTOR (31 downto 0);
        dst_height : IN STD_LOGIC_VECTOR (31 downto 0);
        dst_width : IN STD_LOGIC_VECTOR (31 downto 0);
    ...
    component start_for_resize_IfE IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component resize_ip_AXILiteS_s_axi IS
    generic (
    ...
    port (
        ...
        src_height : OUT STD_LOGIC_VECTOR (31 downto 0);
        src_width : OUT STD_LOGIC_VECTOR (31 downto 0);
        dst_height : OUT STD_LOGIC_VECTOR (31 downto 0);
        dst_width : OUT STD_LOGIC_VECTOR (31 downto 0) );
    end component;



begin
    resize_ip_AXILiteS_s_axi_U : component resize_ip_AXILiteS_s_axi
    generic map (
    ...
    port map (
        ...
        start_full_n => start_for_resize_accel_U0_full_n,
    ...
    port map (
        ...
        img_rows_out_full_n => imgInput1_rows_c9_full_n,
        img_rows_out_write => AXIvideo2xfMat_U0_img_rows_out_write,
        img_cols_out_din => AXIvideo2xfMat_U0_img_cols_out_din,
        img_cols_out_full_n => imgInput1_cols_c10_full_n,
        img_cols_out_write => AXIvideo2xfMat_U0_img_cols_out_write);

    resize_accel_U0 : component resize_accel
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        ap_start => resize_accel_U0_ap_start,
        start_full_n => start_for_xfMat2AXIvideo_U0_full_n,
        ap_done => resize_accel_U0_ap_done,
        ap_continue => resize_accel_U0_ap_continue,
        ap_idle => resize_accel_U0_ap_idle,
        ap_ready => resize_accel_U0_ap_ready,
        start_out => resize_accel_U0_start_out,
        start_write => resize_accel_U0_start_write,
        p_src_rows_dout => imgInput1_rows_c9_dout,
        p_src_rows_empty_n => imgInput1_rows_c9_empty_n,
        p_src_rows_read => resize_accel_U0_p_src_rows_read,
        p_src_cols_dout => imgInput1_cols_c10_dout,
        p_src_cols_empty_n => imgInput1_cols_c10_empty_n,
        p_src_cols_read => resize_accel_U0_p_src_cols_read,
        p_src_data_V_dout => imgInput1_data_V_cha_dout,
        p_src_data_V_empty_n => imgInput1_data_V_cha_empty_n,
        p_src_data_V_read => resize_accel_U0_p_src_data_V_read,
        p_dst_rows_dout => imgOutput1_rows_c_dout,
        p_dst_rows_empty_n => imgOutput1_rows_c_empty_n,
        p_dst_rows_read => resize_accel_U0_p_dst_rows_read,
        p_dst_cols_dout => imgOutput1_cols_c_dout,
        p_dst_cols_empty_n => imgOutput1_cols_c_empty_n,
        p_dst_cols_read => resize_accel_U0_p_dst_cols_read,
        p_dst_data_V_din => resize_accel_U0_p_dst_data_V_din,
        p_dst_data_V_full_n => imgOutput1_data_V_ch_full_n,
        p_dst_data_V_write => resize_accel_U0_p_dst_data_V_write,
        p_dst_rows_out_din => resize_accel_U0_p_dst_rows_out_din,
        p_dst_rows_out_full_n => imgOutput1_rows_c11_full_n,
        p_dst_rows_out_write => resize_accel_U0_p_dst_rows_out_write,
        p_dst_cols_out_din => resize_accel_U0_p_dst_cols_out_din,
        p_dst_cols_out_full_n => imgOutput1_cols_c12_full_n,
        p_dst_cols_out_write => resize_accel_U0_p_dst_cols_out_write);
    ...
    port map (
        ...
        img_rows_dout => imgOutput1_rows_c11_dout,
        img_rows_empty_n => imgOutput1_rows_c11_empty_n,
        img_rows_read => xfMat2AXIvideo_U0_img_rows_read,
        img_cols_dout => imgOutput1_cols_c12_dout,
        img_cols_empty_n => imgOutput1_cols_c12_empty_n,
    ...
    imgOutput1_rows_c_U : component fifo_w32_d3_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        ...
        if_read => resize_accel_U0_p_dst_rows_read);

    imgOutput1_cols_c_U : component fifo_w32_d3_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        ...
        if_read => resize_accel_U0_p_dst_cols_read);

    imgInput1_data_V_cha_U : component fifo_w24_d1_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        ...
        if_read => resize_accel_U0_p_src_data_V_read);

    imgInput1_rows_c9_U : component fifo_w32_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        ...
        if_full_n => imgInput1_rows_c9_full_n,
        if_write => AXIvideo2xfMat_U0_img_rows_out_write,
        if_dout => imgInput1_rows_c9_dout,
        if_empty_n => imgInput1_rows_c9_empty_n,
        if_read => resize_accel_U0_p_src_rows_read);

    imgInput1_cols_c10_U : component fifo_w32_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        ...
        if_full_n => imgInput1_cols_c10_full_n,
        if_write => AXIvideo2xfMat_U0_img_cols_out_write,
        if_dout => imgInput1_cols_c10_dout,
        if_empty_n => imgInput1_cols_c10_empty_n,
        if_read => resize_accel_U0_p_src_cols_read);

    imgOutput1_data_V_ch_U : component fifo_w24_d1_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => resize_accel_U0_p_dst_data_V_din,
        if_full_n => imgOutput1_data_V_ch_full_n,
        if_write => resize_accel_U0_p_dst_data_V_write,
        if_dout => imgOutput1_data_V_ch_dout,
        if_empty_n => imgOutput1_data_V_ch_empty_n,
        if_read => xfMat2AXIvideo_U0_img_data_V_read);

    imgOutput1_rows_c11_U : component fifo_w32_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => resize_accel_U0_p_dst_rows_out_din,
        if_full_n => imgOutput1_rows_c11_full_n,
        if_write => resize_accel_U0_p_dst_rows_out_write,
        if_dout => imgOutput1_rows_c11_dout,
        if_empty_n => imgOutput1_rows_c11_empty_n,
        if_read => xfMat2AXIvideo_U0_img_rows_read);

    imgOutput1_cols_c12_U : component fifo_w32_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => resize_accel_U0_p_dst_cols_out_din,
        if_full_n => imgOutput1_cols_c12_full_n,
        if_write => resize_accel_U0_p_dst_cols_out_write,
        if_dout => imgOutput1_cols_c12_dout,
        if_empty_n => imgOutput1_cols_c12_empty_n,
        if_read => xfMat2AXIvideo_U0_img_cols_read);

    start_for_resize_IfE_U : component start_for_resize_IfE
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => start_for_resize_accel_U0_din,
        if_full_n => start_for_resize_accel_U0_full_n,
        if_write => Block_Mat_exit51_pro_U0_start_write,
        if_dout => start_for_resize_accel_U0_dout,
        if_empty_n => start_for_resize_accel_U0_empty_n,
        if_read => resize_accel_U0_ap_ready);
    ...
    port map (
        ...
        if_write => resize_accel_U0_start_write,
    ...
    ap_done <= xfMat2AXIvideo_U0_ap_done;
    ap_idle <= (xfMat2AXIvideo_U0_ap_idle and resize_accel_U0_ap_idle and Block_Mat_exit51_pro_U0_ap_idle and AXIvideo2xfMat_U0_ap_idle);
    ...
    p_dst_TVALID <= xfMat2AXIvideo_U0_p_dst_TVALID;
    p_src_TREADY <= AXIvideo2xfMat_U0_p_src_TREADY;
    resize_accel_U0_ap_continue <= ap_const_logic_1;
    resize_accel_U0_ap_start <= start_for_resize_accel_U0_empty_n;
    start_for_resize_accel_U0_din <= (0=>ap_const_logic_1, others=>'-');
