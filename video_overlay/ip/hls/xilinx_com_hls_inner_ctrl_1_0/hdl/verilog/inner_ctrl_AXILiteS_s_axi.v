...
`timescale 1ns/1ps
module inner_ctrl_AXILiteS_s_axi
#(parameter
...
localparam
    ...
    ADDR_OUTPUT_V_DATA_0 = 5'h18,
    ADDR_OUTPUT_V_CTRL   = 5'h1c,
    WRIDLE               = 2'd0,
    WRDATA               = 2'd1,
    WRRESP               = 2'd2,
    WRRESET              = 2'd3,
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        else if (ar_hs && raddr == ADDR_INPUT_V_CTRL)
            int_input_V_ap_vld <= 1'b0; // clear on read
    end
end
