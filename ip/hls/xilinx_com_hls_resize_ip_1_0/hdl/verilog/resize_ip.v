...
(* CORE_GENERATION_INFO="resize_ip,hls_ip_2018_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=12.395000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=46,HLS_SYN_DSP=108,HLS_SYN_FF=9622,HLS_SYN_LUT=15413,HLS_VERSION=2018_2}" *)
...
wire    resize_accel_U0_ap_done;
wire    resize_accel_U0_ap_continue;
wire    resize_accel_U0_ap_idle;
wire    resize_accel_U0_ap_ready;
wire    resize_accel_U0_start_out;
wire    resize_accel_U0_start_write;
wire    resize_accel_U0_p_src_rows_read;
wire    resize_accel_U0_p_src_cols_read;
wire    resize_accel_U0_p_src_data_V_read;
wire    resize_accel_U0_p_dst_rows_read;
wire    resize_accel_U0_p_dst_cols_read;
wire   [23:0] resize_accel_U0_p_dst_data_V_din;
wire    resize_accel_U0_p_dst_data_V_write;
wire   [31:0] resize_accel_U0_p_dst_rows_out_din;
wire    resize_accel_U0_p_dst_rows_out_write;
wire   [31:0] resize_accel_U0_p_dst_cols_out_din;
wire    resize_accel_U0_p_dst_cols_out_write;
...
wire   [31:0] xfMat2AXIvideo_U0_p_dst_TDATA;
wire    xfMat2AXIvideo_U0_p_dst_TVALID;
wire   [3:0] xfMat2AXIvideo_U0_p_dst_TKEEP;
wire   [3:0] xfMat2AXIvideo_U0_p_dst_TSTRB;
...
wire   [31:0] imgInput1_rows_c9_dout;
wire    imgInput1_rows_c9_empty_n;
wire    imgInput1_cols_c10_full_n;
wire   [31:0] imgInput1_cols_c10_dout;
...
wire   [0:0] start_for_resize_accel_U0_din;
wire    start_for_resize_accel_U0_full_n;
wire   [0:0] start_for_resize_accel_U0_dout;
wire    start_for_resize_accel_U0_empty_n;
...
resize_ip_AXILiteS_s_axi #(
    .C_S_AXI_ADDR_WIDTH( C_S_AXI_AXILITES_ADDR_WIDTH ),
    .C_S_AXI_DATA_WIDTH( C_S_AXI_AXILITES_DATA_WIDTH ))
resize_ip_AXILiteS_s_axi_U(
...
fifo_w32_d3_A imgOutput1_rows_c_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w32_d3_A imgOutput1_cols_c_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w24_d1_A imgInput1_data_V_cha_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w32_d2_A imgInput1_rows_c9_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w32_d2_A imgInput1_cols_c10_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w24_d1_A imgOutput1_data_V_ch_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w32_d2_A imgOutput1_rows_c11_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w32_d2_A imgOutput1_cols_c12_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
start_for_resize_IfE start_for_resize_IfE_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
assign ap_idle = (xfMat2AXIvideo_U0_ap_idle & resize_accel_U0_ap_idle & Block_Mat_exit51_pro_U0_ap_idle & AXIvideo2xfMat_U0_ap_idle);
...
assign resize_accel_U0_ap_continue = 1'b1;

assign resize_accel_U0_ap_start = start_for_resize_accel_U0_empty_n;

assign start_for_resize_accel_U0_din = 1'b1;
