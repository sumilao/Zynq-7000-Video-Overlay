...
reg   [31:0] p_dst_rows_read_reg_192;
reg    ap_block_state1;
reg   [31:0] p_dst_cols_read_reg_197;
reg   [31:0] p_src_rows_read_reg_202;
reg   [31:0] p_src_cols_read_reg_207;
wire    grp_resize_fu_172_ap_start;
wire    grp_resize_fu_172_ap_done;
wire    grp_resize_fu_172_ap_idle;
wire    grp_resize_fu_172_ap_ready;
wire    grp_resize_fu_172_p_src_data_V_read;
wire   [23:0] grp_resize_fu_172_p_dst_data_V_din;
wire    grp_resize_fu_172_p_dst_data_V_write;
reg    grp_resize_fu_172_ap_start_reg;
...
#0 ap_done_reg = 1'b0;
#0 ap_CS_fsm = 2'd1;
#0 grp_resize_fu_172_ap_start_reg = 1'b0;
end

resize grp_resize_fu_172(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state2) & (grp_resize_fu_172_ap_done == 1'b1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_resize_fu_172_ap_start_reg <= 1'b0;
    end else begin
        if ((~((real_start == 1'b0) | (p_dst_cols_out_full_n == 1'b0) | (p_dst_rows_out_full_n == 1'b0) | (p_dst_cols_empty_n == 1'b0) | (p_dst_rows_empty_n == 1'b0) | (p_src_cols_empty_n == 1'b0) | (p_src_rows_empty_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
            grp_resize_fu_172_ap_start_reg <= 1'b1;
        end else if ((grp_resize_fu_172_ap_ready == 1'b1)) begin
            grp_resize_fu_172_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) & (grp_resize_fu_172_ap_done == 1'b1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    ap_block_state1_ignore_call14 = ((real_start == 1'b0) | (p_dst_cols_out_full_n == 1'b0) | (p_dst_rows_out_full_n == 1'b0) | (p_dst_cols_empty_n == 1'b0) | (p_dst_rows_empty_n == 1'b0) | (p_src_cols_empty_n == 1'b0) | (p_src_rows_empty_n == 1'b0) | (ap_done_reg == 1'b1));
end

assign ap_ready = internal_ap_ready;

assign grp_resize_fu_172_ap_start = grp_resize_fu_172_ap_start_reg;

assign p_dst_cols_out_din = p_dst_cols_dout;

assign p_dst_data_V_din = grp_resize_fu_172_p_dst_data_V_din;
