...
always @ (*) begin
    if ((((tmp_7_i_reg_238_pp0_iter1_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((tmp_7_i_reg_238 == 1'd1) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
        p_dst_x_TDATA_blk_n = AXI_video_strm_V_data_V_1_state[1'd1];
    end else begin
        p_dst_x_TDATA_blk_n = 1'b1;
    end
end
...
assign AXI_video_strm_V_data_V_1_ack_out = p_dst_x_TREADY;
...
assign AXI_video_strm_V_dest_V_1_ack_out = p_dst_x_TREADY;
...
assign AXI_video_strm_V_id_V_1_ack_out = p_dst_x_TREADY;
...
assign AXI_video_strm_V_keep_V_1_ack_out = p_dst_x_TREADY;
...
assign AXI_video_strm_V_last_V_1_ack_out = p_dst_x_TREADY;
...
assign AXI_video_strm_V_strb_V_1_ack_out = p_dst_x_TREADY;
...
assign AXI_video_strm_V_user_V_1_ack_out = p_dst_x_TREADY;
...
assign p_dst_x_TDATA = AXI_video_strm_V_data_V_1_data_out;

assign p_dst_x_TDEST = AXI_video_strm_V_dest_V_1_data_out;

assign p_dst_x_TID = AXI_video_strm_V_id_V_1_data_out;

assign p_dst_x_TKEEP = AXI_video_strm_V_keep_V_1_data_out;

assign p_dst_x_TLAST = AXI_video_strm_V_last_V_1_data_out;

assign p_dst_x_TSTRB = AXI_video_strm_V_strb_V_1_data_out;

assign p_dst_x_TUSER = AXI_video_strm_V_user_V_1_data_out;

assign p_dst_x_TVALID = AXI_video_strm_V_dest_V_1_state[1'd0];
